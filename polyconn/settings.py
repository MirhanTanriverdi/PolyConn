"""
Django settings for polyconn project.
...
SECRET_KEY = "django-insecure-x#lo71sz!^=q&t3rg(8e43j_86dl)q65c&qiozxi*=5xyabqye"
...
INSTALLED_APPS = [
    ...
    'polyconnmain.apps.PolyconnmainConfig',
...
WSGI_APPLICATION = "polyconn.wsgi.application"
